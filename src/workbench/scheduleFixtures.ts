...
export const scheduleWorkbenchCoverage = [
  ...
  { id: 'ui.0104', disposition: 'exempt', reason: 'Live playback control is catalogued by #37.' },
  { id: 'ui.0105', disposition: 'exempt', reason: 'Private live-control child is covered by its parent in #37.' },
  { id: 'ui.0106', disposition: 'exempt', reason: 'Private live-control child is covered by its parent in #37.' },
  ...
  { id: 'ui.0117', disposition: 'exempt', reason: 'Enrollment mutation remains covered as a form overlay in #33 until its service is injectable.' },
