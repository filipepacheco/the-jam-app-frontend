...
export function SpotifyExportModal({
  ...
  const titleContent = (
    <div>
      <span className="font-bold text-lg">{t('spotify.export_modal.title')}</span>
      <p className="text-sm text-base-content/70 font-normal">{t('spotify.export_modal.subtitle')}</p>
    </div>
  )
      ...
      footer={
        !exportResult ? (
          <ModalFooter
            ...
            submitLabel={isSubmitting ? t('spotify.export_modal.exporting') : t('spotify.export_modal.export_button')}
