...
// Spotify logo SVG
export const SpotifyLogo = ({ className = "w-4 h-4" }: { className?: string }) => (
...
export const SpotifyPlayButton = memo(function SpotifyPlayButton({
  ...
  return (
    ...
    <a
      ...
      rel="noopener noreferrer"
      onClick={handleClick}
      className="btn btn-circle btn-ghost btn-sm ds-focusable shrink-0 text-success hover:bg-success/20"
      title={`Open "${title || 'track'}" in Spotify`}
