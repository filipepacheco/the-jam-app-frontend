...
export function StartingSoonCard({ song }: StartingSoonCardProps) {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={transition} className="mb-8">
      <div className="bg-base-200/80 border border-base-300 rounded-2xl p-6 md:p-10 text-center">
        ...
        {song ? (
          <div className="mt-4">
            ...
            <p className="text-3xl md:text-5xl font-bold text-base-content mb-1">{song.title}</p>
            ...
            {song.musicians && song.musicians.length > 0 && (
              <div className="mt-6">
                <p className="text-base md:text-lg font-semibold text-base-content mb-3">
